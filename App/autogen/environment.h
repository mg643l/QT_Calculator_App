...
Q_IMPORT_QML_PLUGIN(QT_Calculator_AppPlugin)
Q_IMPORT_QML_PLUGIN(QT_Calculator_AppContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/QT_Calculator_AppContent/App.qml";
